...
while forest == "incomplete" or river == "incomplete": #on my first go I used "and", this didn't create a loop and kept finishing this condition, so after looking at my code with AI, I found that the OR function must be used.
    ...
    if explore1 == "river" and river == "incomplete":
        ...
        type_text("You see what looks like a fire place that's been stoked out, there are more items there\n")
        time.sleep(2)
        clear_screen()
...
type_text("It's now 10AM and you know you need to prepare some lunch for yourself. Nothing sound better than having a deer!\n")
type_text("You notice some footprints that look like a deer's hoof, thinking of the potential, you follow the lead...\n")
type_text("After scoping around, following the trail, through some tree's and down a slope you see a deer grazing.\n")
        ...
        if catch_deer == "catch" :
            ...
            while True:
                ...
                if caught_deer == "full deer" and deer_health <=0:
                    ...
                    time.sleep(1)
deer_eaten = False
type_text("The suns bright and high above you, right now it's 2pm and you've still got work to do.\n")
    ...
    if opening_option1 == "lake":
        ...
        while True:
            ...
            if stay_woodland == "yes":
                    ...
                    type_text("Hmmm its strange for an eagle to have a piece of paper... maybe you should hold on to that...\n")
...
type_text("Running away the sounds of wolves, you enter a dense, misty forest.\n")
